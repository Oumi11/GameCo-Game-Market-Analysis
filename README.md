...
### 2. Global and Market Specific Game Genre Analysis
...
<br><br>
<p align="center">
  <img src="https://github.com/user-attachments/assets/77b671db-6d11-41e3-b50e-a8661697b6e1" width="900" />
</p>

<br><br>
### This graph illustrates the top 10 competitors in 2016 for each region: 
- **Take-Two Interactive, Microsoft Game Studios and Activision are strongly positioned in the North American market**
- **Warner Bros. Interactive Entertainment, Ubisoft, Sony Computer Entertainment and Electronics Arts are the main competitors in Europe**
- **Square Enix is the major competitor in Japan**

<br><br>

## Conclusion & Recommendations
### The data showed a decreasing trend in global sales. It is then prudent to review the initial budget proposal for the creation of new games. The risk of the supply not meeting the demand could result in a significant financial deficit for the organization. 

- **Focus on popular game genres: GameCo should prioritize action, shooter, and sports games to capitalize on global sales trends, considering regional preferences.**
- **Competitive strategy: GameCo should adopt a more aggressive strategy to establish itself in the North American and European markets dominated by top competitors.**
- **Market proportionality: Allocate sales reps proportionally to market size, focusing on NA and EU as the largest markets, given the overlapping sales in NA, Europe, and Japan.**
